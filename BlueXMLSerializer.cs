...
namespace Lab_9 {
    public class BlueXMLSerializer : BlueSerializer {
        ...
        public override void SerializeBlue1Response(Blue_1.Response participant, string fileName)
        {
            ...
            SelectFile(fileName);
            ResponseDTO dto = new ResponseDTO(participant);
        ...
        public override void SerializeBlue2WaterJump(Blue_2.WaterJump participant, string fileName)
        {
            if (participant == null || String.IsNullOrEmpty(fileName)) {return;}
            SelectFile(fileName);
            WaterJumpDTO dto = new WaterJumpDTO(participant);
        ...
        public override void SerializeBlue3Participant<T>(T student, string fileName) where T: class
        {
            ...
            SelectFile(fileName);
            ParticipantB3DTO dto = new ParticipantB3DTO(student);
        ...
        public override void SerializeBlue4Group(Blue_4.Group participant, string fileName)
        {
            if (participant == null || String.IsNullOrEmpty(fileName)) {return;}
            SelectFile(fileName);
            GroupDTO dto = new GroupDTO(participant);
        ...
        public override Blue_1.Response DeserializeBlue1Response(string fileName)
        {
            ...
            {
                dto = (ResponseDTO)serializer.Deserialize(reader);
            }
            if (dto.Surname != null)
            {
                deserialized = new Blue_1.HumanResponse(dto.Name, dto.Surname, dto.Votes);
            }
            else {
                deserialized = new Blue_1.Response(dto.Name, dto.Votes);
            }
            return deserialized;
        }
        ...
        public override Blue_2.WaterJump DeserializeBlue2WaterJump(string fileName)
        {
            ...
            using (var reader = new StreamReader(FilePath))
            {
                dto = (WaterJumpDTO)serializer.Deserialize(reader);
            }
        ...
        {
            SelectFile(fileName);
            Blue_3.Participant deserialized = null;
            ParticipantB3DTO dto;
            var serializer = new XmlSerializer(typeof(ParticipantB3DTO));
            using (var reader = new StreamReader(FilePath))
            {
                dto = (ParticipantB3DTO)serializer.Deserialize(reader);
            }
        ...
        public override Blue_4.Group DeserializeBlue4Group(string fileName)
        {
            ...
            using (var reader = new StreamReader(FilePath))
            {
                dto = (GroupDTO)serializer.Deserialize(reader);
            }
        ...
        public override T DeserializeBlue5Team<T>(string fileName)
        {
            ...
            using(var reader = new StreamReader(FilePath))
            {
                if (typeof(T) == typeof(Blue_5.Sportsman)) {
                    var serializer = new XmlSerializer(typeof(SportsmanDTO));
                    SportsmanDTO dto = (SportsmanDTO)serializer.Deserialize(reader);
                    Blue_5.Sportsman deserialized = new Blue_5.Sportsman(dto.Name, dto.Surname);
                    deserialized.SetPlace(dto.Place);
                    return deserialized as T;
                }
                else {
                    var serializer = new XmlSerializer(typeof(TeamB5DTO));
                    TeamB5DTO dto = (TeamB5DTO)serializer.Deserialize(reader);
