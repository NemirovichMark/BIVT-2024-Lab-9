...
namespace Lab_9
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            PurpleXMLSerializer _xml = new PurpleXMLSerializer();
            PurpleJSONSerializer _json = new PurpleJSONSerializer();
            PurpleTXTSerializer _txt = new PurpleTXTSerializer();

            var XMLSerialize = new Serialize(_xml);
            var JSONSerialize = new Serialize(_json);
            var TXTSerialize = new Serialize(_txt);

            XMLSerialize.serialize1();
            XMLSerialize.Deserialize1();

            JSONSerialize.serialize1();
            JSONSerialize.Deserialize1();

            TXTSerialize.serialize2();
            TXTSerialize.Deserialize2();
        }
    }
    public class Serialize
    {
        private dynamic serializer;
        public Serialize(dynamic obj)
        {
            serializer = obj;
            serializer.SelectFolder(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "serialize", obj.GetType().ToString()));
        }
        ...
        public void serialize1()
        {
            ...
            serializer.SerializePurple1(participant, "purple1Participant");
            serializer.SerializePurple1(judge, "purple1Judge");
            serializer.SerializePurple1(competition, "purple1Competition");
        }
        public void serialize2()
        {
            ...
            serializer.SerializePurple2SkiJumping(juniorSkiJumping, "juniorSkiJumping");
            serializer.SerializePurple2SkiJumping(proSkiJumping, "proSkiJumping");
        }
        public void serialize5()
        {
            var report = CreateObj.CreatePurple5Report();

            serializer.SerializePurple5Report(report, "report");

        }

        public void Deserialize1()
        {
            var participant = serializer.DeserializePurple1<Purple_1.Participant>("purple1Participant");
            var judge = serializer.DeserializePurple1<Purple_1.Judge>("purple1Judge");
            var competition = serializer.DeserializePurple1<Purple_1.Competition>("purple1Competition");
        }
        public void Deserialize2()
        {
            var proSkiJumping = serializer.DeserializePurple2SkiJumping<SkiJumping>("proSkiJumping");
            var juniorSkiJumping = serializer.DeserializePurple2SkiJumping<SkiJumping>("juniorSkiJumping");
            serializer.SerializePurple2SkiJumping(juniorSkiJumping, "juniorSkiJumpingTest");
            serializer.SerializePurple2SkiJumping(proSkiJumping, "proSkiJumpingTest");
        }
        public void Deserialize5()
        {
            var report = serializer.DeserializePurple5Report("report");
        }
    }
