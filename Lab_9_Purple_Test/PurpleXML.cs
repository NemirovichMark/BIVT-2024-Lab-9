...
{
    [TestClass]
    public sealed class PurpleXML
    {
        private Random _rand = new Random();
        PurpleSerializer _serializer = new PurpleXMLSerializer();
        ...
        public void Test_01_Hierarchy()
        {
            ...
            Assert.IsTrue(_serializer is PurpleXMLSerializer);
        }
        [TestMethod]
        public void Test_02_CreateFolder()
        {
            Assert.IsTrue(IFileManagerTest.Check_CreateFolder(_serializer, $"Purple_XML"));
            CheckFolder();
        }
        [TestMethod]
        public void Test_03_CreateFile()
        {
            Assert.IsTrue(IFileManagerTest.Check_CreateFile(_serializer, $"Purple_XML", $"Purple_task", "xml"));
            CheckFile();
        }
        [TestMethod]
        public void Test_04_Purple1_XML_1()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_04_Purple1_XML_2()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_04_Purple1_XML_3()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_05_Purple2_XML()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_06_Purple3_XML()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_07_Purple4_XML()
        {
            Init();
            Test_03_CreateFile();
        ...
        [TestMethod]
        public void Test_08_Purple5_XML()
        {
            Init();
            Test_03_CreateFile();
        ...
        private void Init()
        {
            _serializer = new PurpleXMLSerializer();
        }
        private void CheckFolder()
        {
            var pathes = IFileManagerTest.Check_Properties(_serializer);
            Assert.AreEqual(pathes.folder, Path.Combine(IFileManagerTest.GeneralPath, $"Purple_XML"));
        ...
        private void CheckFile()
        {
            var pathes = IFileManagerTest.Check_Properties(_serializer);
            Assert.AreEqual(pathes.folder, Path.Combine(IFileManagerTest.GeneralPath, $"Purple_XML"));
            Assert.AreEqual(pathes.file, Path.Combine(IFileManagerTest.GeneralPath, $"Purple_XML", $"Purple_task.xml"));
        }
