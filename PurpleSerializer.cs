...
namespace Lab_9
{
    public abstract class PurpleSerializer :  FileSerializer
    {
        ...
        //публичные абстрактные методы сериализаторы (объект -> текст)

        //универсальный(обобщенный) метод (generic) T-типа-заполнитель (произвольный тип)
        //будет заменен на реаольный тип при вызове 
        ...
        //обычные методы-сериализаторы (не обобщенный метод)
        ...
        //публичные абстрактные методы - десериализаторы 
